...
const CategorySearch = () => {
  ...
  {categoryList.map((item,index)=>(
    <div key={index} className="flex flex-col  text-center items-center gap-2 m-2 rounded-lg bg-blue-50  p-5 hover:scale-110 transition-all ease-in-out cursor-pointer">
